...
pacman::p_load(dplyr, ggplot2, reshape2) # packages needed
...
data dictionary in this repo `nhanes_data_dictionary.csv` which
...
-   Based on the numbers above, what was the compliance rate for monitor
    ...
    *hint: This is usually expressed as a percentage*
