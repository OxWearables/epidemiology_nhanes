...
data dictionary in this repo which describes what each variable in the
dataset is.
...
2.  Are there any differences in stepping metrics between weekend and
    ...
    *hint: you can mostly copy the code used from the previous chunk to
    view this.*
3.  Are there any summaries for any variables which you feel may need
    considering in tomorrows epidemiology analysis?
